...
class YoloStereo3DCore(nn.Module):
    ...
    def __init__(self, backbone_arguments):
        ...
        self.backbone =resnet(**backbone_arguments) # Resnet, change backbone from here
    ...
    def forward(self, images):
        ...
        features = self.backbone(images) #applying backbone on images
        print("shape of features in forward pass in yolostereo3dcore", features[-1].shape)
