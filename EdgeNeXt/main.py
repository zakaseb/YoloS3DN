...
def main(args):
    ...
    #                                          is_training=False, distributed=args.distributed, #is_training put as false just for eval only purposes. Change to true when training
    ...
    # if args.dist_eval: # this is for distributed Eval
